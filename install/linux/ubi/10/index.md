...
{% include /new-includes/assigns/linux-platform-builds.html
    ...
    development="main"
    docker_tag="nightly-rhel-ubi10"
    development_builds=site.data.builds.development.ubi10
    aarch64_development_builds=site.data.builds.development.ubi10-aarch64
    development_2="release/6.4.x"
    docker_tag_2="nightly-6.4.x-rhel-ubi10"
    development_builds_2=site.data.builds.swift-6_4_x-branch.ubi10
    aarch64_development_builds_2=site.data.builds.swift-6_4_x-branch.ubi10-aarch64

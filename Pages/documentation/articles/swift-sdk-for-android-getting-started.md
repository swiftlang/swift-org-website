...
Installing Swift #(releaseName)

Installing package in user home directory...
Swift #(releaseName) is installed successfully!
$ swiftly use latest
The global default toolchain has been set to `Swift #(releaseName)`

$ swift --version
Apple Swift version #(releaseName) (#(releaseTag))
...
```console
$ swift build --swift-sdk #(releaseTag)_android --triple x86_64-unknown-linux-android23 --static-swift-stdlib
Building for debugging...
[8/8] Linking hello
...
```console
$ swift build --swift-sdk #(releaseTag)_android --triple aarch64-unknown-linux-android23 --static-swift-stdlib
Building for debugging...
[8/8] Linking hello
Build complete! (2.04s)

...
You can find out more about the new diagnostic architecture on a [previously published blog post](https://swift.org/blog/new-diagnostic-arch-overview/) dedicated to that topic.
...
Official binaries for Ubuntu 18.04 and Ubuntu 16.04 are [available for download](https://swift.org/download/).

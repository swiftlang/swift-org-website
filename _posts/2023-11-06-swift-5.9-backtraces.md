...
Darwin and Windows systems, often doesn't have a system-wide crash
...
In situations where you know you do not want this feature enabled, you
can explicitly disable it by setting the environment variable

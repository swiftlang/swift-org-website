...
Macros are implemented using a powerful and flexible approach: they are simply Swift functions that use the [SwiftSyntax](https://github.com/apple/swift-syntax) library to generate code to be inserted into the source file.

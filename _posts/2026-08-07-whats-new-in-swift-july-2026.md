...
> 
> The Website Workgroup happened to be my way in, but there are groups like it across the project—server, testing, Windows, Android, and more—each a handful of people looking after their part of the ecosystem. Whatever you're good at or curious about, there's probably a corner of Swift that could use your help. The [community page](/community/) is a good place to start looking, and the people you'll meet are some of the friendliest I've come across in open source.
> 
...
* **Task Stealers, a new primitive in Swift Concurrency's runtime, [recently merged](https://github.com/swiftlang/swift/pull/86082)** after generating the liveliest discussion of any PR in July. They change how work gets distributed across the cooperative thread pool, an under-the-hood change worth watching if you write concurrency-heavy code.
...
## Swift Evolution
The Swift project adds new features through the [Swift Evolution process](/swift-evolution/). These are some of the proposals recently accepted for a future Swift release.

...
Tag: [swift-5.6.1-RELEASE](https://github.com/apple/swift/releases/tag/swift-5.6.1-RELEASE)
...
Swift 5.6 RPMs for Amazon Linux 2 and CentOS 7 for **experimental use only**. Please provide your [feedback](https://bugs.swift.org).
</div>

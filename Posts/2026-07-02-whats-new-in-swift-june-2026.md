...
* Want to learn about Swift macros with hands-on tutorials? Stewart Lynch published two videos with sample code to follow along: [Swift Macros Demystified: Build a Freestanding Expression Macro](https://www.youtube.com/watch?v=7W6R2TIoEW8), and [Swift Attached Macros: Build a Real-World Member Macro from Scratch](https://www.youtube.com/watch?v=iQYEG3tPWpw).
